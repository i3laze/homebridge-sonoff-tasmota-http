...
Below is an *optional* hardware modification [Step 2](http://www.instructables.com/id/Sonoff-Garage-Door-Opener/) that transforms Sonoff's output pins into an isolated circuit, able to toggle any electric circuits (with any voltage!), which have control pins, like garage-door control unit:
